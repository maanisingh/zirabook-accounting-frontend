...
const Features = () => {
  ...
  return (
    <div>
      ...
      <section style={{ backgroundColor: '#e7ffe7ff', fontFamily: 'Segoe UI, sans-serif', color: '#333', padding: '40px 0' }}>
        <Container>
      ...
      <section className="py-4 py-md-5" style={{ backgroundColor: "#e9ecef" }}>
        <Container data-aos="fade-up">
          ...
          <Row>
            {[
              ...
              >
                <div
                  className="bg-white p-4 rounded shadow-sm h-100 text-center"
                  ...
                  <div className="mb-3">
                    <i
                      ...
                      style={{
                        ...
                        ...(window.innerWidth < 360 ? { fontSize: "40px" } : {})
                      }}
                    ></i>
                  </div>
