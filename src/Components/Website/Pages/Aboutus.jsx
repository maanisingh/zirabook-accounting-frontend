        ...
        <div className=" md-5 px-3 px-md-5">
          <div className="row align-items-center ">
            ...
            <div className="col-lg-6 mb-4 mb-lg-0">
              ...
              <p className="mb-4" style={{ color: 'black', fontSize: '1rem', lineHeight: '1.6' }}>
              ...
              <div className="row g-3">
                <div className="col-sm-6">
                  <div className="d-flex">
                    <div className="rounded-circle d-flex align-items-center justify-content-center me-3 flex-shrink-0" style={{ width: '48px', height: '48px', backgroundColor: 'rgba(133, 72, 54, 0.1)' }}>
                      <FontAwesomeIcon icon={faCheckCircle} style={{ color: '#338871', fontSize: '1.25rem' }} />
                    </div>
                    <div>
                      <h3 className="h5 fw-semibold mb-1" style={{ color: '#338871' }}>Accuracy</h3>
                ...
                <div className="col-sm-6">
                  <div className="d-flex">
                    <div className="rounded-circle d-flex align-items-center justify-content-center me-3 flex-shrink-0" style={{ width: '48px', height: '48px', backgroundColor: 'rgba(133, 72, 54, 0.1)' }}>
                      <FontAwesomeIcon icon={faLightbulb} style={{ color: '#338871', fontSize: '1.25rem' }} />
                    </div>
                    <div>
                      <h3 className="h5 fw-semibold mb-1" style={{ color: '#338871' }}>Simplicity</h3>
                ...
                <div className="col-sm-6">
                  <div className="d-flex">
                    <div className="rounded-circle d-flex align-items-center justify-content-center me-3 flex-shrink-0" style={{ width: '48px', height: '48px', backgroundColor: 'rgba(133, 72, 54, 0.1)' }}>
                      <FontAwesomeIcon icon={faShieldAlt} style={{ color: '#338871', fontSize: '1.25rem' }} />
                    </div>
                    <div>
                      <h3 className="h5 fw-semibold mb-1" style={{ color: '#338871' }}>Compliance Ready</h3>
                ...
                <div className="col-sm-6">
                  <div className="d-flex">
                    <div className="rounded-circle d-flex align-items-center justify-content-center me-3 flex-shrink-0" style={{ width: '48px', height: '48px', backgroundColor: 'rgba(133, 72, 54, 0.1)' }}>
                      <FontAwesomeIcon icon={faComments} style={{ color: '#338871', fontSize: '1.25rem' }} />
                    </div>
                    <div>
                      <h3 className="h5 fw-semibold mb-1" style={{ color: '#338871' }}>Bilingual Support</h3>
